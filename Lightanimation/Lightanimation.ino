 ...
 *///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 // This is the START of the program 4
     // This block, for example, defines names such as "C1" as 9. so now, the following are equal:   
      // digitalWrite(9, HIGH);
#define C4 10   //                                                                                    digitalWrite(C1, HIGH);
#define C3 11   // This is useful to me. I don't need to know what pin it is, and I would rather know what row or column it is
#define C2 12   // connected to it, so it is nice to be able to essentially rename pin 9 by setting the contant "C1" as 9.
#define C1 13
  #define R1 5
  #define R2 2
  #define R3 3
...
void begloop(){
cy++;        // This block keeps track of the cycles that my program goes
  ...
  delay(20);           //  The number in the bracket sets the amount of time the arduino
